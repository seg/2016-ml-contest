...
submission_singlemodel$Facies <- predict(model_list$knn, testing)
...
pred_majority_vote <- as.data.frame(lapply(list(rf = model_list$rf, knn = model_list$knn, mlpML = model_list$mlpML), function(x) predict(x, testing)))
