...
#Normalizing
train_test_prod_factor = c('Well.Name', 'Formation', 'NM_M', 'Facies')
train_test_prod_cat = train_test_prod[,colnames(train_test_prod) %in% train_test_prod_factor]
train_test_prod_num = train_test_prod[,!colnames(train_test_prod) %in% train_test_prod_factor]
train_test_prod_num = scale(train_test_prod_num)
train_test_prod_num = data.frame(train_test_prod_num)
train_test_prod = cbind(train_test_prod_num, train_test_prod_cat)
...
write.csv(sub, row.names= F, 'RF_predicted_facies_11.csv')
