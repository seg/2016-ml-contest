...
train_local = train_prod[!train_prod$Well.Name %in% c('CHURCHMAN BIBLE'),]
test_local  = train_prod[train_prod$Well.Name %in% 'CHURCHMAN BIBLE',]
set.seed(100)
...
write.csv(sub, row.names= F, 'RF_predicted_facies_8.csv')
