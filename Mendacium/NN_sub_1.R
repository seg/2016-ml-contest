...
acc_table_DL_h2o = table(test_local$Facies, DL.local.pred.h2o$predict)
#acc_table_DL_h2o
...
sub = cbind(test_prod, Facies = DL.prod.pred.h2o)
write.csv(sub, row.names= F, 'NN_predicted_facies_1.csv')
